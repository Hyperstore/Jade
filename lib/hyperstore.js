        ...
        SchemaElement.prototype.defineProperty = function (name, schema, defaultValue, kind) {
            ...
            if (desc.kind == 0 /* Normal */) {
                Object.defineProperty(this.proto, desc.name, {
                    ...
                    configurable: true,
                    get: function () {
                        return Hyperstore.ModelElement.prototype.getPropertyValue.call(this, desc);
                    },
                    set: function (value) {
                        Hyperstore.ModelElement.prototype.setPropertyValue.call(this, desc, value);
                    }
                });
            }
            else {
    ...
    var SchemaParser = (function () {
        ...
        SchemaParser.prototype._resolveType = function (name) {
            ...
            if (parts.length == 1) {
                ...
                fullName = state.id + Hyperstore.Store.IdSeparator + parts[1];
            }
    ...
    var DomainModel = (function () {
        ...
        DomainModel.prototype.loadFromJson = function (def, rootSchema) {
            ...
            if (Hyperstore.Utils.isArray(def)) {
                ...
                this.store.runInSession(function () {
                    Hyperstore.Utils.forEach(def, function (e) { return list.push(_this.parseJson(e, rootSchema, refs)); });
                });
                return list;
            }
            else {
                var r;
                this.store.runInSession(function () { return r = [_this.parseJson(def, rootSchema, refs)]; });
                return r;
            }
        };
        DomainModel.prototype.parseJson = function (obj, schema, refs) {
            ...
            for (var member in obj) {
                ...
                if (prop) {
                    mel.setPropertyValue(prop, prop.deserialize(new Hyperstore.SerializationContext(this, melInfo.id, undefined, undefined, undefined, undefined, val)));
                    continue;
                }
                ...
                if (rel) {
                    ...
                    var values = val;
                    if (Hyperstore.Utils.isArray(val)) {
                        if (!rel.isCollection) {
...
(function (Hyperstore) {
    ...
    var Store = (function () {
        ...
        Store.prototype.createDomain = function (config, p) {
            ...
            var domain = new Hyperstore.DomainModel(this, domainName);
            var self = this;
            var tasks;
            if (config.adapters) {
                tasks = [];
        ...
        Store.prototype.populateDomain = function (def, domain) {
            ...
            if (def.data) {
                for (var name in def.data) {
                    ...
                    domain["root"] = Hyperstore.Utils.firstOrDefault(domain.loadFromJson(def.data[name], root));
                    break;
                }
            }
        };
