    ...
    var SchemaElement = (function (_super) {
        ...
        SchemaElement.prototype.defineProperty = function (name, schema, defaultValue, kind) {
            ...
            if (name.name) {
                ...
                desc = new Hyperstore.SchemaProperty(name, schema, defaultValue, kind);
            }
...
(function (Hyperstore) {
    var SchemaState = (function () {
        function SchemaState(store, config) {
            ...
            if (store) {
                this.constraints = {};
                this.id = config.id;
                this.schema = new Hyperstore.Schema(store, this.id);
                this.meta = {};
            }
        }
    ...
    var SchemaParser = (function () {
        ...
        SchemaParser.prototype.parse = function (schema) {
            ...
            this.parseConstraints(schema.constraints, function (ct) { return _this._state.constraints[ct.name] = ct; });
            this.pendings = [];
        ...
        SchemaParser.prototype.parseEntity = function (o, name) {
            ...
            var entity = new Hyperstore.SchemaEntity(this._state.schema, name, base);
        ...
        SchemaParser.prototype.trySharedTypes = function (state, name, propertyName) {
            var _this = this;
            ...
            var valueObject = new Hyperstore.SchemaValueObject(state.schema, name);
...
(function (Hyperstore) {
    var DomainModel = (function () {
        ...
        DomainModel.prototype.createId = function (id) {
            ...
            return this.name + Hyperstore.Store.IdSeparator + (id || Hyperstore.Utils.newGuid());
        };
            ...
            if (Hyperstore.Utils.isArray(def)) {
                ...
                this.store.runInSession(function () {
                    Hyperstore.Utils.forEach(def, function (e) {
                        var mel = _this.__parseJson(e, rootSchema, refs);
                        if (mel)
                            list.push(mel);
                    });
                }, 4 /* Loading */);
                ...
                var r;
                this.store.runInSession(function () { return r = [_this.__parseJson(def, rootSchema, refs)]; }, 4 /* Loading */);
                return r;
            }
        };
        DomainModel.prototype.__parseJson = function (obj, rootSchema, refs) {
            ...
            if (schema.loadFromJson) {
                mel = schema.loadFromJson(this, obj);
            }
            if (!mel) {
        ...
        DomainModel.prototype.copy = function (mel, refs) {
            var _this = this;
            refs = refs || {};
            var schema = mel.getSchemaElement();
            var ownerId = this.createId(Hyperstore.Utils.splitIdentity(mel.getId())[1]);
            ...
            mel.getSchemaElement().getProperties(true).forEach(function (prop) {
                ...
                var node = _this._graph.getPropertyNode(pid);
                node = _this._graph.addPropertyNode(pid, prop.schemaProperty.id, node.value, Hyperstore.Utils.getUtcNow());
                _this._raiseEvent(new Hyperstore.ChangePropertyValueEvent(_this.name, ownerId, schema.id, prop.name, prop.serialize(node.value), undefined, node.version));
            });
        ...
        DomainModel.prototype.setPropertyValue = function (ownerId, property, value, version) {
            ...
            this._raiseEvent(new Hyperstore.ChangePropertyValueEvent(this.name, ownerId, ownerNode.schemaId, property.name, property.serialize(pv.value), property.serialize(pv.oldValue), pv.version));
            return pv;
        };
...
(function (Hyperstore) {
    var ModelElement = (function () {
        ...
        ModelElement.prototype.getParent = function () {
            var rel = this.getRelationships(undefined, 1 /* Incoming */).firstOrDefault(function (r) { return r.embedded; });
            ...
            for (var member in obj) {
                ...
                if (rel) {
                    ...
                    for (var i in values) {
                        ...
                        var src = rel.opposite ? elem : this;
                        var end = rel.opposite ? this : elem;
        ...
        ModelElement.prototype.dump = function (indent) {
            var _this = this;
            ...
            this.getSchemaElement().getProperties(true).forEach(function (prop) {
                console.log(tab + " " + prop.name + " = " + _this.get(prop));
            });
            var lastRelSchema;
