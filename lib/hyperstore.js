    ...
    var SchemaElement = (function (_super) {
        ...
        SchemaElement.prototype.onAfter = function (ctx) {
            if (this._interceptors) {
                Hyperstore.Utils.forEach(this._interceptors, function (i) { return ctx.action === "Create" ? i.afterCreate && i.afterCreate(ctx.mel) : i.afterRemove && i.afterRemove(ctx.id, ctx.schema); });
            }
            if (this.baseElement)
        ...
        SchemaElement.prototype.onBefore = function (ctx) {
            if (this._interceptors) {
                Hyperstore.Utils.forEach(this._interceptors, function (i) { return ctx.action === "Create" ? i.beforeCreate && i.beforeCreate(ctx.mel) : i.beforeRemove && i.beforeRemove(ctx.mel); });
            }
            if (this.baseElement)
