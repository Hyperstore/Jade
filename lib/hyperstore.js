...
(function (Hyperstore) {
    var SchemaElement = (function (_super) {
        ...
        SchemaElement.prototype.getKeyValueFromJson = function (data, parent) {
            ...
            keyProperties.forEach(function (p) { return keys.push(data[p.name] || empty); });
...
(function (Hyperstore) {
    var SchemaState = (function () {
        function SchemaState(store, config, schema, ext) {
    ...
    var Loader = (function () {
        ...
        Loader.prototype.loadSchemas = function (schemas, overrides) {
            ...
            this.store.schemas.forEach(function (s) { return _this._schemas.add(s.name, new SchemaState(_this.store, { id: s.name }, s, false)); });
