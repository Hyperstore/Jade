...
var HypergraphEx = (function (_super) {
    ...
    function HypergraphEx(domain) {
        ...
        this._superHyperGraph = domain.graph;
    }
...
var DomainSerializer = (function () {
    ...
    DomainSerializer.prototype.serializeRelationships = function (relationships) {
        ...
        while (relationships.hasNext()) {
            ...
            var info = relationship.getInfo();
            var startSchema = this._writer.pushElement("relationship", this.getId(info.id), this.getSchemaMoniker(info.schemaElement.id), this.getId(info.startId), this.getSchemaMoniker(info.startSchemaId), this.getId(info.endId), this.getSchemaMoniker(info.endSchemaId));
