...
var Session = (function () {
    ...
    Session.prototype.getDomain = function (domain) {
...
var Hypergraph = (function () {
    ...
    Hypergraph.prototype.updatePropertyNode = function (owner, node) {
        if (node.needsUpdate)
            owner.properties[node.id] = node;
    };

    Hypergraph.prototype.addPropertyNode = function (owner, id, schemaId, value, version) {
    ...
    Hypergraph.prototype.getPropertyNode = function (owner, name) {
...
var HypergraphEx = (function (_super) {
    ...
    HypergraphEx.prototype.getPropertyNode = function (owner, name) {
        var node = _super.prototype.getPropertyNode.call(this, owner, name);
        if (node)
            return node;
...
var ModelElementArray = (function () {
    function ModelElementArray(_collection) {
        ...
        var self = this;
        this._sessionCompletedCookie = this._collection.getDomain().store.onSessionCompleted(function (s) {
            if (s.aborted) {
                return;
            }
    ...
    ModelElementArray.prototype.reset = function () {
        ...
        var cursor = this._collection.getDomain().getRelationships(this._collection.schemaRelationship, this._collection.source, this._collection.end);
...
var ModelElementCollection = (function (_super) {
    ...
    ModelElementCollection.prototype.getDomain = function () {
